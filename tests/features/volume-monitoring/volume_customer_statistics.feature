Feature: Volume statistics of the customers
  ...
  Scenario: Gather customers statistics about the average size of the products
    The potential size of the products is defined by the number of product values that it could contain
  ...
  Scenario: Gather customers statistics about the potential size of the products
    ...
    and the potential number product value is defined by the attributes in its family
  ...
  @acceptance-back
  Scenario: Gather customers statistics about the maximum number of product values per family
    Given a channel defined with 2 activated locales
